...
public class Align : SteeringBehavior
{
    ...
    float maxAngularAcceleration = 10f; // 10
    float maxRotation = 5f; // 5 maxSpeed or max angular velocity

    // the radius for arriving at the target
    float targetRadius = 2f; // maybe better word is tolerance

    // the radius for beginning to slow down
    float slowRadius = 2f; // 2
    ...
    public override SteeringOutput getSteering()
    {
        ...
        result.angular = targetRotation - character.angular;
